...
class MyPro extends StatelessWidget {
  final String lang,desc,title,star;
  final Function () onPressed;

  MyPro({super.key, required this.lang, required this.desc, required this.title, required this.star, required this.onPressed});
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  CustomButton(path: 'assets/github.svg', onPressed: (){},),
                ],
              )
            ],
          ),
